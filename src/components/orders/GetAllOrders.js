...
import { Card, Spinner, Alert, Badge, Row, Col, Form, InputGroup, Button, Container } from "react-bootstrap";
import { Link } from "react-router-dom";
import { FaSearch, FaEye, FaSort, FaFilter, FaCalendarAlt, FaUser, FaShoppingBag } from "react-icons/fa";
...
function GetAllOrders() {
  ...
  const filteredOrders = orders
    ?.filter(order => {
      const matchesSearch = 
        order.user_details?.email?.toLowerCase().includes(searchTerm.toLowerCase()) ||
                    ...
                    <tr key={order.id}>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <div className="fw-semibold">{order.user_details?.email}</div>
                            {order.user_details && (
